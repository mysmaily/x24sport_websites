...
export const categoryMenu: CategoryMenuGroup[] = [
  ...
  { slug: 'gaming', name: 'Gaming', children: [] },
  { slug: 'bi-a', name: 'Bi-a', children: [] },
  {
    slug: 'dong-phuc',
    name: 'Đồng Phục',
    children: [
...
export function getCategorySeoProfile(category: SportCategory): CategorySeoProfile {
  ...
  if (parent) {
    ...
    return {
      ...
      intro: child?.description || category.description || `Bộ sưu tập ${category.name} thuộc danh mục ${parent.name}, tập trung vào đúng nhóm sản phẩm bạn đang tìm.`,
