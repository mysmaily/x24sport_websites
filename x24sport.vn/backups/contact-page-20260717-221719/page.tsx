...
import { ArrowRight, ChevronRight, Clock3, Globe2, Headphones, Layers3, Mail, MapPin, MessageCircle, PackageCheck, Phone, Search, Shirt, Sparkles, Truck } from 'lucide-react'
  ...
  return (
    <section className="product-shelf">
      ...
      <div className="shelf-products">
        <div className="shelf-heading"><div><p>{subtitle}</p><h2>{title}</h2></div><Link href="/san-pham">Xem tất cả <ChevronRight size={17} /></Link></div>
        {items.length
        ...
        <div className="footer-main">
          <div className="footer-about">
            ...
            <div className="footer-contact-list">
              <p><MapPin size={17} /><span><strong>Miền Bắc:</strong> 6 Ngõ 50 Nguyễn Hữu Thọ, Hoàng Liệt, Hà Nội</span></p>
              <p><MapPin size={17} /><span><strong>Miền Nam:</strong> 86/10 đường 12, P.Tam Bình, Thủ Đức, TP.HCM</span></p>
              <p><MapPin size={17} /><span><strong>Xưởng SX:</strong> Ngõ 32 Đại Từ, Hoàng Mai, Hà Nội</span></p>
              <a href="tel:0989353247"><Phone size={17} /><span><strong>Hotline:</strong> 0989.353.247</span></a>
              <a href="mailto:x24sport.vn@gmail.com"><Mail size={17} /><span><strong>Email:</strong> x24sport.vn@gmail.com</span></a>
              <a href="https://x24sport.vn/"><Globe2 size={17} /><span><strong>Website:</strong> https://x24sport.vn</span></a>
              <a href="https://www.facebook.com/vnx24sport/"><MessageCircle size={17} /><span><strong>Facebook:</strong> facebook.com/vnx24sport</span></a>
            </div>
          </div>
          ...
          <div><h3>Hỗ trợ</h3><a href="#quy-trinh">Cách đặt hàng</a><a href="tel:0989353247">Tư vấn thiết kế</a><a href="#lien-he">Kênh liên hệ</a></div>
        </div>
...
export default async function HomePage() {
    ...
    '@graph': [
      {
        ...
        logo: 'https://cdn.x24sport.vn/wp-content/uploads/2025/03/Asset-1-1200x158.png',
  ...
  return (
    <div className="storefront-page">
      ...
      <main id="noi-dung" className="site-container">
        <section className="hero-directory" id="bo-mon">
          <div className="promo-hero">
            <Image preload quality={70} src="/images/brand/hero-teamwear.webp" alt="Đội ngũ vận động viên mặc trang phục thể thao thiết kế" fill sizes="(max-width: 760px) 100vw, 65vw" />
            <div className="promo-shade" />
            <div className="promo-copy"><span>X24SPORT / CUSTOM TEAMWEAR</span><h1>TRANG PHỤC<br />CHO MỌI<br />CHUYỂN ĐỘNG</h1><p>Thiết kế đồng phục thể thao theo màu sắc và tinh thần riêng của đội bạn.</p><a href="#san-pham">Khám phá ngay <ArrowRight size={18} /></a></div>
          </div>
      ...
      <div className="floating-contact" aria-label="Liên hệ nhanh"><a href="tel:0989353247" aria-label="Gọi X24Sport"><Phone /></a><a href="#lien-he" aria-label="Xem kênh liên hệ X24Sport"><MessageCircle /></a></div>
    </div>
  )
}
