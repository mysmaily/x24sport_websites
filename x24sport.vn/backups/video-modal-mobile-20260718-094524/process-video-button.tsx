...
const defaultProcessVideoUrl = 'https://youtube.com/shorts/6xRsweuvz0o?si=CXDsWxtogNUegtRk'
const rawVideoUrl = process.env.NEXT_PUBLIC_PROCESS_VIDEO_URL?.trim() || defaultProcessVideoUrl
...
function toEmbeddableUrl(url: string) {
  ...
  try {
    ...
    if (parsed.hostname.includes('youtube.com')) {
      ...
      const videoId = parsed.searchParams.get('v') || (pathParts[0] === 'shorts' ? pathParts[1] : '')
      return videoId ? `https://www.youtube.com/embed/${videoId}` : url
    }
