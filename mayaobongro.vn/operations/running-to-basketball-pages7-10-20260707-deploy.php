...
$batchRoot = $argv[2] ?? '/var/www/mayaobongro.vn/wp-content/uploads/codex-ops/running-to-basketball-pages7-10-20260707';
...
foreach (pages56_load_manifest($batchRoot) as $record) {
    ...
    $backupPath = $backupDir . '/product-' . $productId . '-before-pages7-10-conversion.json';
    ...
    $elementaryMediaId = pages56_ensure_media(
        $elementaryPath,
        $codeSlug . '-tieu-hoc-' . $productId . '-pages7-10',
    ...
    $highSchoolMediaId = pages56_ensure_media(
        $highSchoolPath,
        $codeSlug . '-thpt-' . $productId . '-pages7-10',
