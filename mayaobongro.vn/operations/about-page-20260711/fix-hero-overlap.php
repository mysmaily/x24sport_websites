...
$backupDir = rtrim($batchRoot, '/') . '/backups/' . gmdate('Ymd-His') . '-fix-hero-overlap';
...
$pageId = (int) $page->ID;
file_put_contents(
    $backupDir . '/page-92-before-fix-hero-overlap.json',
    wp_json_encode([
...
$content = <<<'HTML'
[ux_banner height="280px" height__sm="245px" bg="19" bg_overlay="rgba(0, 0, 0, 0.56)" parallax="0"]

[text_box position_x="50" position_y="68"]

[ux_text]

<h1 style="text-align: center;font-size: 32px;line-height: 1.15;margin: 0 0 10px">Giới thiệu về Mayaobongro.vn</h1>
<p style="text-align: center;font-size: 17px;line-height: 1.45;margin: 0"><strong>Xưởng may áo bóng rổ thiết kế riêng cho đội nhóm</strong></p>
