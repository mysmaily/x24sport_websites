...
$backupDir = rtrim($batchRoot, '/') . '/backups/' . gmdate('Ymd-His') . '-refine';
...
[ux_banner height="190px" height__sm="150px" bg="19" bg_overlay="rgba(0, 0, 0, 0.56)" parallax="0"]

[text_box position_x="50" position_y="50"]

[ux_text]

<h1 class="x24-about-hero-title" style="text-align: center;">Giới thiệu về Mayaobongro.vn</h1>
<p class="x24-about-hero-subtitle" style="text-align: center;"><strong>Xưởng may áo bóng rổ thiết kế riêng cho đội nhóm</strong></p>
...
file_put_contents(
    $backupDir . '/page-92-after-refine.json',
