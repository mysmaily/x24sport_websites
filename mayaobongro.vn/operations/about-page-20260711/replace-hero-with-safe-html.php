...
$backupDir = rtrim($batchRoot, '/') . '/backups/' . gmdate('Ymd-His') . '-safe-html-hero';
...
$pageId = (int) $page->ID;
file_put_contents(
    $backupDir . '/page-92-before-safe-html-hero.json',
    wp_json_encode([
...
$content = <<<'HTML'
<div style="min-height: 285px; box-sizing: border-box; padding: 124px 20px 44px; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; border-top: 4px solid #d50000; background: linear-gradient(rgba(34, 45, 57, .88), rgba(34, 45, 57, .88)), url('https://mayaobongro.vn/wp-content/uploads/2016/08/dummy-2.jpg') center/cover no-repeat;">
<div style="max-width: 900px; margin: 0 auto;">
<h1 style="text-align: center; font-size: 34px; line-height: 1.18; margin: 0 0 12px; color: #fff;">Giới thiệu về Mayaobongro.vn</h1>
<p style="text-align: center; font-size: 18px; line-height: 1.45; margin: 0; color: #fff;"><strong>Xưởng may áo bóng rổ thiết kế riêng cho đội nhóm</strong></p>
</div>
</div>
