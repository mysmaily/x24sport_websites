...
$elementaryMediaId = tb_ensure_media(
    $elementaryImagePath,
    'saigon-u60-x24-br-004-tieu-hoc-1758',
    'Bộ bóng rổ tiểu học SAIGON U60 gradient X24-BR-004',
    'Ảnh mẫu tiểu học lớp 4-5 mặc bộ quần áo bóng rổ SAIGON U60 gradient hồng vàng xanh X24-BR-004',
    'Ảnh mẫu tiểu học lớp 4-5 cho thiết kế bóng rổ SAIGON U60 gradient'
);
$highSchoolMediaId = tb_ensure_media(
    $highSchoolImagePath,
    'saigon-u60-x24-br-004-thpt-1758',
    'Bộ bóng rổ THPT SAIGON U60 gradient X24-BR-004',
    'Ảnh mẫu học sinh cấp 3 mặc bộ quần áo bóng rổ SAIGON U60 gradient hồng vàng xanh X24-BR-004',
    'Ảnh mẫu trung học / cấp 3 cho thiết kế bóng rổ SAIGON U60 gradient'
);

$newTitle = 'Bộ Quần Áo Bóng Rổ Học Sinh SAIGON U60 Gradient X24-BR-004';
$newSlug = 'bo-quan-ao-bong-ro-hoc-sinh-saigon-u60-gradient-x24-br-004';
$excerpt = 'Bộ quần áo bóng rổ học sinh SAIGON U60 Gradient X24-BR-004 phối hồng, vàng và xanh dương nổi bật, form bóng rổ suông cùng quần đồng bộ cho đội trường.';
$description = <<<HTML
<h2>Bộ quần áo bóng rổ học sinh SAIGON U60 gradient</h2>
<p>Thiết kế SAIGON U60 được chuyển sang form bóng rổ học sinh với phối màu hồng, vàng và xanh dương nổi bật. Áo sát nách có vai rộng hơn, cổ và nách viền rib, thân suông dài che cạp quần để học sinh thoải mái dẫn bóng, chuyền bóng và phối hợp đồng đội.</p>
<p>Quần bóng rổ đi kèm dùng dáng rộng ngang gối, phối gradient đồng bộ với áo để giữ tinh thần thiết kế gốc nhưng phù hợp sân bóng rổ. Mẫu này hợp cho đội lớp, câu lạc bộ hoặc giải giao hữu học sinh cần một bộ đồng phục bóng rổ trường học nhiều màu, dễ nhận diện.</p>
...
<figure class="mayaobongro-age-reference"><img src="[TB_ELEMENTARY_URL]" alt="Ảnh mẫu tiểu học lớp 4-5 mặc bộ quần áo bóng rổ SAIGON U60 gradient hồng vàng xanh X24-BR-004"><figcaption>Ảnh mẫu tiểu học lớp 4-5 cho thiết kế bóng rổ SAIGON U60 gradient.</figcaption></figure>
...
<figure class="mayaobongro-age-reference"><img src="[TB_THPT_URL]" alt="Ảnh mẫu học sinh cấp 3 mặc bộ quần áo bóng rổ SAIGON U60 gradient hồng vàng xanh X24-BR-004"><figcaption>Ảnh mẫu trung học / cấp 3 cho thiết kế bóng rổ SAIGON U60 gradient.</figcaption></figure>
<h3>May theo đội trường</h3>
<ul>
<li>Giữ tinh thần SAIGON U60, gradient hồng, vàng, xanh dương và các điểm nhấn đỏ.</li>
<li>Áo và quần phối cùng gradient, viền và đường chéo để thành một bộ bóng rổ hoàn chỉnh.</li>
...
update_post_meta($savedProductId, '_mayaobongro_edition_group', 'saigon-u60-gradient-pink-yellow-blue');
...
update_post_meta(
    ...
    'Bộ quần áo bóng rổ học sinh SAIGON U60 Gradient X24-BR-004, có ảnh mẫu tiểu học lớp 4-5, THCS lớp 9 và cấp 3/THPT.'
);
