...
$productId = isset($argv[2]) ? (int) $argv[2] : 1762;
...
$elementaryMediaId = tb_ensure_media(
    $elementaryImagePath,
    'vovinam-da-nang-x24-br-005-tieu-hoc-1762',
    'Bộ bóng rổ tiểu học Vovinam Đà Nẵng vàng xanh X24-BR-005',
    'Ảnh mẫu tiểu học lớp 4-5 mặc bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh X24-BR-005',
    'Ảnh mẫu tiểu học lớp 4-5 cho thiết kế bóng rổ Vovinam Đà Nẵng vàng xanh'
);
$highSchoolMediaId = tb_ensure_media(
    $highSchoolImagePath,
    'vovinam-da-nang-x24-br-005-thpt-1762',
    'Bộ bóng rổ THPT Vovinam Đà Nẵng vàng xanh X24-BR-005',
    'Ảnh mẫu học sinh cấp 3 mặc bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh X24-BR-005',
    'Ảnh mẫu trung học / cấp 3 cho thiết kế bóng rổ Vovinam Đà Nẵng vàng xanh'
);

$newTitle = 'Bộ Quần Áo Bóng Rổ Vovinam Đà Nẵng Vàng Xanh X24-BR-005';
$newSlug = 'bo-quan-ao-bong-ro-vovinam-da-nang-vang-xanh-x24-br-005';
$excerpt = 'Bộ quần áo bóng rổ Vovinam Đà Nẵng X24-BR-005 phối vàng xanh nổi bật, form bóng rổ suông và quần đồng bộ cho đội nhóm, CLB hoặc đặt may riêng.';
$description = <<<HTML
<h2>Bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh</h2>
<p>Thiết kế Vovinam Đà Nẵng được chuyển sang form bóng rổ với nền vàng năng động, điểm nhấn xanh lam và tinh thần võ đạo Việt Nam. Áo sát nách có vai rộng hơn, cổ và nách viền rib, thân suông dài che cạp quần để người mặc thoải mái dẫn bóng, chuyền bóng và phối hợp đồng đội.</p>
<p>Quần bóng rổ đi kèm dùng dáng rộng ngang gối, phối vàng xanh đồng bộ với áo để giữ nhận diện CLB nhưng phù hợp sân bóng rổ. Mẫu này hợp cho đội nhóm, CLB, lớp học, công ty hoặc khách đặt may riêng cần một bộ đồng phục bóng rổ sáng màu, dễ nhận diện.</p>
...
<figure class="mayaobongro-age-reference"><img src="[TB_ELEMENTARY_URL]" alt="Ảnh mẫu tiểu học lớp 4-5 mặc bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh X24-BR-005"><figcaption>Ảnh mẫu tiểu học lớp 4-5 cho thiết kế bóng rổ Vovinam Đà Nẵng vàng xanh.</figcaption></figure>
...
<figure class="mayaobongro-age-reference"><img src="[TB_THPT_URL]" alt="Ảnh mẫu học sinh cấp 3 mặc bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh X24-BR-005"><figcaption>Ảnh mẫu trung học / cấp 3 cho thiết kế bóng rổ Vovinam Đà Nẵng vàng xanh.</figcaption></figure>
<h3>May theo đội trường</h3>
<ul>
<li>Giữ tinh thần Vovinam Đà Nẵng, nền vàng nổi bật và điểm nhấn xanh lam.</li>
...
update_post_meta($savedProductId, '_mayaobongro_edition_group', 'vovinam-da-nang-yellow-blue');
...
update_post_meta(
    ...
    'Bộ quần áo bóng rổ Vovinam Đà Nẵng vàng xanh X24-BR-005, có ảnh mẫu tiểu học lớp 4-5, THCS lớp 9 và cấp 3/THPT.'
);
