...
const productId = 1776;
const slug = 'bo-quan-ao-bong-ro-hoc-sinh-nipro-fdl-song-khoe-hong-xanh';
const oldSlug = 'ao-chay-bo-nipro-mau-hong-xanh-duong-noi-bat-fdl-song-khoe';
...
const product = await fetchJson(`https://mayaobongro.vn/wp-json/wp/v2/product/${productId}?_fields=id,slug,title,link,featured_media,categories,product_cat,content,excerpt,yoast_head_json`);
...
const report = {
  ...
  source_domain_in_html: html.includes('mayaochaybo.vn'),
...
if (report.source_domain_in_html) throw new Error('Public HTML still includes source domain.');
