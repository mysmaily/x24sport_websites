...
[/col]
[col span="4" span__sm="12" align="left" class="x24-product-summary-col"]
...
[/col]
[col span="3" span__sm="12" align="left" class="mbro-product-sales-col"]
...
if (!$dryRun && !is_dir($backupRoot) && !mkdir($backupRoot, 0755, true)) {
...
if (!$dryRun) {
    file_put_contents(
        $backupRoot . '/block-1647-before-three-column-product-top.json',
...
echo wp_json_encode([
    ...
    'block_id' => $blockId,
    'old_has_top_panel' => str_contains((string) $block->post_content, 'mbro_product_top_sales_panel'),
    'new_has_top_panel' => str_contains($newContent, 'mbro_product_top_sales_panel'),
    'new_columns' => [
        'media' => 'span 5',
        'summary' => 'span 4',
        'sales' => 'span 3',
