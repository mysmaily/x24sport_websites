  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-slate-100">
        ...
        <span className="absolute bottom-4 left-4 rounded-full bg-slate-950/90 px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-white backdrop-blur">X24 / Basketball</span>
        {imageCount > 1 ? (
          <>
