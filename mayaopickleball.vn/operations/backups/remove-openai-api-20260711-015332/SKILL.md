...
- Female face rendering should stay naturally bright and fair with lively eyes
  and a warm, attractive smile. Prefer a soft youthful Vietnamese beauty feel:
  gentle jawline, slightly fuller soft cheeks, fresh skin, and a graceful
  "nang tho" catalog mood rather than a severe, hardened, older-than-intended,
  blank, or over-defined face. Keep face, neck, arms, and legs color-consistent
  and realistic. Reject muddy, gray, sallow, overly tanned, plastic,
  filter-white, waxy, artificially sharpened, or face/body skin mismatch
  results.
...
- Image B neckline/sleeve rule: male must wear `áo cổ tròn, không có ống tay`.
  Female must wear `áo không có ống tay`; normally this is a collared no-sleeve
  jersey, but a smaller deterministic random share may use round neck no-sleeve.
