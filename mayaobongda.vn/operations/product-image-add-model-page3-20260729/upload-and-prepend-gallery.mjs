...
const OPERATION = 'product-image-add-model-page3-20260729'
...
const main = async () => {
  const before = JSON.parse(await readFile(join(ROOT, 'page3-products-before.json'), 'utf8'))
  const products = before.docs || before
