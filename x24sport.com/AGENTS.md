# x24sport.com — Managed Website Profile

> Scope: This file contains only data and runbooks specific to `x24sport.com`.
...
run `ruby ../scripts/website_registry.rb sync domain=x24sport.com` to refresh only this website block. Local notes outside
the markers are preserved.

| Field | Value |
|-------|-------|
| Website registry ID | 28 |
| Configuration registry ID | 119 |
| Configuration status | pending |
| Display name | x24sport-com |
...
| WordPress content directory | /root/websites/sites/x24sport.com/wp-content |
| Source directory | /root/websites/sites/x24sport.com |
...
```bash
ruby ../scripts/website_registry.rb cloudflare-token x24sport.com
```
