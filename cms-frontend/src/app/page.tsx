...
import { ArrowRight, ChevronRight, Clock3, Headphones, Layers3, PackageCheck, Shirt, Sparkles, Truck } from 'lucide-react'
      ...
      <main id="noi-dung" className="site-container">
        <section className="hero-directory" id="bo-mon">
          <div className="promo-hero">
            <Image preload fetchPriority="high" quality={75} src="/images/brand/hero-teamwear-bluehour-20260827.webp" alt="Đội ngũ vận động viên mặc trang phục thể thao thiết kế" fill sizes="(max-width: 760px) 100vw, 65vw" />
