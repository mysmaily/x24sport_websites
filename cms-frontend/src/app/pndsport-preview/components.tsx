...
export function SiteShell({ children }: { children: ReactNode }) {
  return <div className={styles.site}>
    ...
    <div className={styles.mobileBar}><a href="tel:0989353247"><Phone size={17} /> Gọi tư vấn</a><a href="https://zalo.me/0989353247" target="_blank" rel="noreferrer"><MessageCircle size={17} /> Gửi yêu cầu</a></div>
  </div>
}
