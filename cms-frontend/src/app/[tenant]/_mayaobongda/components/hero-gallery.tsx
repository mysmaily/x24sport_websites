...
export function HeroGallery({ slides, totalProducts }: { slides: HeroSlide[]; totalProducts: number }) {
  ...
  if (!activeSlide) return <div className="grid min-h-[420px] place-items-center rounded-[2rem] border border-white/10 bg-white/5 font-display text-8xl font-bold text-white/15">FC</div>

  return (
    <section
      aria-label="Bộ sưu tập mẫu áo bóng đá nổi bật"
