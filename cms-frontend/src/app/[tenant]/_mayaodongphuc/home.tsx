...
const process = [
  ...
  { icon: Sparkles, step: '02', title: 'Đề xuất cấu hình', text: 'Phom, vật liệu, bảng màu và kỹ thuật logo phù hợp.' },
