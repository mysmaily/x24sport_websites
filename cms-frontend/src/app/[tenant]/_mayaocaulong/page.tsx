...
const buyerPaths = [
  ...
  },
  {
    ...
    image: '/images/mayaocaulong/badminton-hero.webp?v=20260728b',
  },
  {
...
const fabricCards = [
  ...
  { title: 'Form thi đấu gọn', text: 'Vai và nách đủ linh hoạt để đập cầu, phòng thủ, di chuyển ngang liên tục.' },
...
const proofNotes = [
  {
    title: 'Duyệt mẫu trước khi may',
    text: 'Đội xem maket màu, logo, tên số và góp ý trước khi chuyển sang sản xuất.',
  },
  {
    title: 'Chia size theo danh sách',
    text: 'Danh sách size, tên, số áo được gom theo từng thành viên để hạn chế nhầm khi phát áo.',
  },
  {
    title: 'Tư vấn theo lịch thi đấu',
    text: 'Khi có deadline cụ thể, đội được tư vấn phương án chất liệu và tiến độ phù hợp hơn.',
  },
] as const
...
const organizationJsonLd = {
  ...
  '@type': 'OnlineStore',
  name: 'MayaoCauLong',
  url: 'https://mayaocaulong.vn/',
  logo: 'https://mayaocaulong.vn/images/mayaocaulong/badminton-team-hero.png?v=20260728b',
  image: 'https://mayaocaulong.vn/images/mayaocaulong/badminton-team-hero.png?v=20260728b',
  telephone: phone,
  areaServed: 'VN',
  sameAs: [zaloHref],
}
...
const websiteJsonLd = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://mayaocaulong.vn/tim-kiem/?q={search_term_string}',
...
const faqs = [
  {
    question: 'Có nhận thiết kế áo cầu lông theo logo riêng không?',
...
const articleCards = [
  { title: 'Cách chọn màu áo nổi bật trên sân cầu lông', href: '/blog/', text: 'Gợi ý phối màu theo sân xanh, ánh đèn trong nhà và logo đội.' },
  { title: 'Checklist đặt áo cho CLB trước mùa giải', href: '/blog/', text: 'Những thông tin nên chuẩn bị để chốt maket nhanh và tránh nhầm size.' },
  { title: 'Polo hay cổ tròn phù hợp với đội của bạn?', href: '/blog/', text: 'So sánh cảm giác mặc, độ chỉn chu và tình huống sử dụng.' },
] as const
    ...
    <main className="site-page">
      ...
      <section className="section-shell buyer-section" id="dat-thiet-ke">
        <div className="section-heading compact">
          ...
          <p>Khách mua áo cầu lông thường không chỉ cần một mẫu đẹp. Họ cần đúng form, đúng màu và kịp lịch thi đấu.</p>
        </div>
      ...
      <section className="court-story">
        <div className="court-story-copy">
          ...
          <p>
            Với cầu lông phong trào, áo không chỉ để mặc. Màu áo giúp đội dễ nhận diện,
          ...
          <ul>
            ...
            <li>Màu nền cân bằng với ánh đèn sân trong nhà.</li>
            <li>Form áo gọn vai, không cản động tác vung vợt.</li>
          </ul>
        </div>
      ...
      <section className="section-shell fabric-section" id="chat-lieu">
        <div className="fabric-visual">
          <img
            alt="Chi tiết áo cầu lông đặt may trên sân"
            height={1100}
            src="/images/mayaocaulong/badminton-hero.webp?v=20260728b"
            width={980}
          />
        </div>
        <div className="fabric-copy">
          <h2>Chất liệu và form được chọn cho nhịp di chuyển cầu lông</h2>
      ...
      <section className="section-shell proof-section">
        <div className="proof-copy">
          ...
          <p>
            Xem sản phẩm đang có, các hướng phối màu và bài mẫu đã làm để chọn form áo, màu chủ đạo,
            vị trí logo và cách in tên số cho đội.
          </p>
        </div>
        <div className="proof-mosaic">
          <img alt="Đội cầu lông mặc áo thi đấu đỏ trắng" src="/images/mayaocaulong/badminton-team-hero.png?v=20260728b" />
          <img alt="Áo cầu lông đặt may trên sân" src="/images/mayaocaulong/badminton-hero.webp?v=20260728b" />
          <img alt="Phối màu áo cầu lông theo đội" src="/images/mayaocaulong/badminton-team-hero.png?v=20260728b" />
        </div>
      </section>

      <section className="section-shell review-section">
        <div className="section-heading compact">
          <h2>Những điểm đội cần chốt rõ trước khi sản xuất</h2>
          <p>MayaoCauLong tập trung vào maket dễ duyệt, size dễ phát và tiến độ dễ theo dõi.</p>
        </div>
            ...
            <article key={item.title}>
              ...
              <div>
                <span>
                  ...
                  <small>Áp dụng cho đơn đội và CLB</small>
                </span>
              </div>
            </article>
          ))}
      ...
      <section className="section-shell content-section">
        <div className="section-heading">
          ...
          <p>Trang chủ nên có thêm kiến thức mua hàng để khách mới hiểu quy trình đặt áo cầu lông.</p>
        </div>
        <div className="article-grid">
          {[...articleCards, ...posts.slice(0, 2).map((post) => ({ title: post.title, href: getPostHref(post), text: post.excerpt }))].slice(0, 5).map((item) => (
            <article key={item.title}>
              <h3>{item.title}</h3>
              <p>{item.text}</p>
      ...
      <footer className="site-footer">
        ...
        <div>
          <h3>Liên hệ</h3>
          <p>Hotline: {phone}</p>
          <p>Email: lienhe@mayaocaulong.vn</p>
