...
export const metadata: Metadata = pageMetadata({
  ...
  image: { url: '/images/mayaochaybo/images/audience-landings/doanh-nghiep-vinaseed-green-run.webp', width: 1448, height: 1086, alt: 'Áo chạy bộ doanh nghiệp thiết kế riêng cho hoạt động nội bộ' },
