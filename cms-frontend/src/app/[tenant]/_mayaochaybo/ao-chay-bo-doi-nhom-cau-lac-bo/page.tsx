...
export const metadata: Metadata = pageMetadata({
  ...
  image: { url: '/images/mayaochaybo/audience-landings/doi-nhom-viet-nam-running-club.webp', width: 1448, height: 1086, alt: 'Đội chạy bộ mặc áo câu lạc bộ thiết kế riêng' },
