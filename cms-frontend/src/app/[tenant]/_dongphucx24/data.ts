...
export const categories: DemoCategory[] = [
  ...
  { name: 'Bảo hộ & kỹ thuật', slug: 'dong-phuc-bao-ho-ky-thuat', eyebrow: 'Kho · Xưởng · Hiện trường', description: 'Cấu hình theo vai trò, điều kiện mặc và nhận diện.', image: '/images/mayaodongphuc/workwear-olive.webp' },
...
export const products: DemoProduct[] = [
  ...
  { name: 'Polo công ty navy phối teal hiện đại', slug: 'polo-cong-ty-navy-teal', sku: 'DPX24-PO-004', category: 'dong-phuc-cong-ty', image: 'https://static.x24sport.vn/mayaodongphuc/ao-polo-dong-phuc-cong-ty-navy-teal-hien-dai-anh-chinh-92cbeee349b8.webp', alt: 'Mẫu polo công ty navy phối teal', material: 'Cấu hình cổ, bo và vị trí logo', useCase: 'Đội ngũ doanh nghiệp', accent: '#14b8a6' },
