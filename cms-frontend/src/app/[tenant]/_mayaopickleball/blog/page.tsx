...
export async function generateMetadata({ searchParams }: { searchParams: SearchParams }): Promise<Metadata> {
  ...
  return pageMetadata({
    title: `Blog áo pickleball${page > 1 ? ` – Trang ${page}` : ''} | MayaoPickleball`,
    description: 'Kinh nghiệm chọn mẫu, vải, size và cách đặt may áo pickleball cho đội nhóm, câu lạc bộ và giải giao hữu.',
