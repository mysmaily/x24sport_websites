          ...
          <section className="product-buy-panel">
            ...
            <div className="product-deal-box">
              <div className="product-deal-price">
                ...
                <div className="product-deal-main-price">
                  <strong>{formatPrice(product.price)}</strong>
                  {discountPercent ? <span>Giảm {discountPercent}%</span> : null}
                </div>
                {compareAtPrice ? (
                  <div className="product-deal-original">
                    <span>Giá gốc</span>
                    <del>{formatPrice(compareAtPrice)}</del>
                  </div>
                ) : null}
              </div>
              {promotionSavings ? <p className="product-deal-savings">Tiết kiệm {formatPrice(promotionSavings)} trên mỗi mẫu</p> : null}
            </div>
