...
export async function PndProductPage({ slug }: { slug: string }) {
  ...
  const priceLabel = price ? formatPrice(price) : 'Liên hệ báo giá'
    ...
    <article className={styles.productDetail}>
      ...
      <div className={styles.productLayout}>
        ...
        <section className={styles.productInfo}>
          ...
          <div className={styles.productPrice}><small>Giá thấp nhất</small><strong>{priceLabel}</strong></div>
