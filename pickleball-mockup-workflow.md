...
- For batches, generate one image per product/source.
...
5. Generate pickleball mockups.
6. Export high-quality WebP.
7. Generate final contact sheet.
8. If the user asked to publish, dry-run CMS import first.
9. Back up affected CMS records before apply.
10. Upload media/create or update products.
11. Verify API, media URLs, product pages, categories, and filters.
