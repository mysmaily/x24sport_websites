...
Constraints: artwork only; preserve the design's colors, layout, and intentional texture; no text, lettering, player name or number, logo, crest, badge, sponsor mark, garment, model, seams, hanger, shadows, photo background, web UI, watermark, border, or extra artwork
```
