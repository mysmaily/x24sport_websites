...
- `THIẾT KẾ OMBRE` / `HIỆN ĐẠI` when the product uses ombre; otherwise describe the actual design
...
- Use a distinct Version B scene as the catalog hero. In v2, the finished integrated catalog may be generated directly as Version B; it cannot be just a crop of main with text added.
...
- The catalog may combine Version A details with its own Version B hero photography when this improves garment explanation.
