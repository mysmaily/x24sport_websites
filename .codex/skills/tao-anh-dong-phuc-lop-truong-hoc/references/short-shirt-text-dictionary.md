# Short Shirt Text Dictionary

Use this dictionary when the user has not supplied class text but the shirt needs a temporary short phrase for mockups. Pick one phrase that fits the garment style and scene. Short phrases are easier to render, easier to print, and safer on small shirt areas than long slogans.
