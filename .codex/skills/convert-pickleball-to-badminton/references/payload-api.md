...
slug: text, unique
sku: text
sport: select, one of badminton, volleyball, football, basketball, running, pickleball
price: number
...
status fields. The runner therefore uses:

- deterministic reservation SKU: `x24-cl-transfer-<sha-prefix>`;
