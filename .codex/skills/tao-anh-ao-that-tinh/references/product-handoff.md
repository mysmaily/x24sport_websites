...
Use this manifest to transfer an accepted heartbreak-themed shirt product into `create-tenant-product` without uploading the full-resolution print master.
...
{
  "schemaVersion": "1.1",
  "producerSkill": "tao-anh-ao-that-tinh",
  ...
  "productIdentity": {
    "sku": "X24-DP-NNNNNN",
    "sourceSystem": "tao-anh-ao-that-tinh",
  ...
  "acceptedImages": [
    {
      ...
      "width": 1254,
      "height": 1254,
      "altSeed": "Áo nhóm chủ đề thất tình hài hước với artwork chữa lành và mã mẫu X24-DP-NNNNNN.",
      "captionSeed": "Mẫu áo giúp nhóm bạn chọn concept thất tình vui vẻ, tự trào và dễ tùy chỉnh.",
      "visualTags": ["áo thất tình", "áo nhóm", "chữa lành", "mặt trước"],
    ...
    },
    {
      ...
      "width": 1254,
      "height": 1254,
      "altSeed": "Nhóm bạn mặc áo chủ đề thất tình vui vẻ trong bối cảnh trường học.",
      "captionSeed": "Mẫu áo tạo điểm nhấn đồng bộ cho nhóm bạn, lớp học hoặc CLB với tinh thần vui trở lại.",
      "visualTags": ["áo thất tình", "học sinh", "nhóm bạn", "sân trường", "mặt trước"],
  ...
  "artworkFacts": {
    ...
    "subject": "Chủ thể minh họa thất tình an toàn",
  ...
  "safetyNotes": "Concept thất tình hài hước/chữa lành, không nhắm vào cá nhân thật và không có nội dung tự hại.",
  "audiences": ["lớp học", "nhóm bạn"],
  "useCases": ["áo nhóm", "áo lớp", "đồng phục chủ đề thất tình"],
  ...
  "copySeeds": ["áo thất tình", "áo nhóm hài hước", "đặt may theo yêu cầu"]
}
```
