...
export async function generateMetadata({ searchParams }: { searchParams: Promise<SearchParams> }): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Tìm mẫu áo cầu lông theo tên sản phẩm, màu sắc và tag ảnh sản phẩm.',
...
export default async function SearchPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <CatalogPageContent
      ...
      subtitleOverride="Kết quả được lọc theo tên sản phẩm, tag sản phẩm và tag của ảnh trong gallery."
    />
  )
}
