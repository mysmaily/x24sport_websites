...
const testimonials = [
  {
    ...
    role: 'Đội trưởng CLB Cầu Lông Linh Đàm',
    image: 'https://picsum.photos/seed/badminton-review-khang/200/200',
  },
  {
    ...
    image: 'https://picsum.photos/seed/badminton-review-ha/200/200',
  },
  {
    ...
    image: 'https://picsum.photos/seed/badminton-review-viet/200/200',
  },
] as const
...
const articleCards = [
  { title: 'Cách chọn màu áo nổi bật trên sân cầu lông', href: '#', text: 'Gợi ý phối màu theo sân xanh, ánh đèn trong nhà và logo đội.' },
    ...
    <main className="site-page">
      ...
      <section className="hero-section">
        <div className="hero-media" aria-hidden="true">
          <img src="/images/badminton-team-hero.png" alt="" />
        </div>
      ...
      <section className="section-shell fabric-section" id="chat-lieu">
        <div className="fabric-visual">
          <img
            ...
            height={1100}
            src="https://picsum.photos/seed/badminton-fabric-closeup/980/1100"
            width={980}
          />
        </div>
      ...
      <section className="section-shell proof-section">
        ...
        <div className="proof-mosaic">
          <img alt="Đội cầu lông mặc áo thi đấu đỏ trắng" src="/images/badminton-team-hero.png" />
          <img alt="Áo cầu lông trên sân trong nhà" src="https://picsum.photos/seed/badminton-uniform-court/760/520" />
          <img alt="Maket áo cầu lông nhiều màu" src="https://picsum.photos/seed/badminton-jersey-layout/760/520" />
        </div>
      </section>
